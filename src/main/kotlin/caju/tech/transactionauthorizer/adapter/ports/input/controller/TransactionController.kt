...
class TransactionController(
    ...
    override fun authorize(@RequestBody authorizerTransactionRequest: AuthorizerTransactionRequest): ResponseEntity<TransactionResponse> {
        logger.info("Request received to authorize a new transaction: [{}].", authorizerTransactionRequest)
        val authorizerTransactionResponse = authorizerTransactionUseCasePort.execute(authorizerTransactionRequest.toDomain())
        logger.info("Transaction authorized with success!")
